...
class AccountManager(BaseUserManager):
    def create_user(self, phone=None, email=None, username=None, password=None):
    ...
    def create_superuser(self, phone=None, email=None, username=None, password=None):
        user = self.create_user(phone=phone, email=email, username=username, password=password)
        user.is_staff = True
